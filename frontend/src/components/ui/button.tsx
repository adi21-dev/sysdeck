  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97] touch-action-manipulation",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-md hover:bg-destructive/95",
        outline:
        ...
        neu:
          "neu-control text-foreground hover:text-primary",
        "glass-shine":
          "glass-shine text-foreground hover:bg-accent hover:text-accent-foreground shadow-md",
      },
      size: {
        ...
        icon: "h-10 w-10",
        "icon-touch": "h-12 w-12 rounded-xl",
      },
    },
    defaultVariants: {
      variant: "default",
